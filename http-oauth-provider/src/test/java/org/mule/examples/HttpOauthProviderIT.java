...
{
	private static final String HTTP_ENDPOINT = "http://localhost:9091/authorize?response_type=code&client_id=myclientid&scope=READ_RESOURCE&redirect_uri=http://localhost:9092/redirect";
	private static final Object REPLY_NAME = "payroll";
	private static final Object REPLY_URL = "http://localhost:9092/resources/payroll"; 
    ...
    public void oauthTest() throws Exception
    {
        ...
        MuleMessage result = client.send("http://localhost:9092/resources", "", props);
